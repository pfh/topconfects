...
<!--
devtools::load_all(".") ; rmarkdown::render("vignettes/fold_change.Rmd", intermediates_dir="/tmp", output_dir="/tmp")
-->
...
knitr::opts_chunk$set(cache=FALSE, fig.width=7, fig.height=6)
```


```{r load, dependson="", message=FALSE, warning=FALSE}
library(topconfects)
